...
export default function BigText({ tuckedIn }) {
  return (
    <section id="bigTextSect" className={styles.bigTextCont}>
      ...
      <img className={styles.zzzGif} src="/zzzsGif.gif" />
      {/* <svg
        id="Layer_2"
        data-name="Layer 2"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 626.68 491.53"
        className={styles.bigTextPillow}
        style={{
          transform: tuckedIn ? "translateX(0vw)" : "translateX(-150vw)",
        }}
      >
      ...
      <svg
        className={styles.comforter}
        id="Layer_2"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1921 549.69"
      >
        <g
          className={styles.comfortTwo}
          style={{
            transform: tuckedIn ? "translateY(0vw)" : "translateY(150vw)",
          }}
          id="Layer_1-2"
          data-name="Layer_1"
        >
          <path d="M.5,30.19S299.5-4.81,458.5,1.19s237,21.31,468,14.15,442-20.15,557-6.15,248,16.31,306,6.15,131-6.15,131-6.15v540H.5V30.19Z" />
          <path d="M1.98,68.59c122.74-25.25,248.04-34.12,373.16-35.51,124.78-1.39,249.48,4.34,374.18,7.73,124.32,3.39,248.76,4.16,372.82-5.91,63.12-5.12,126.19-11.93,189.57-12.65s126.7,8.28,189.91,18.12,122.45,15.13,184.64,12.83c62.56-2.32,124.74-10.44,186.61-19.67,15.6-2.33,31.19-4.73,46.78-7.14,1.9-.29,1.09-3.18-.8-2.89-64.1,9.89-128.29,19.76-193.02,24.49-64.39,4.71-128.38,3.15-192.33-5.86-60.73-8.56-120.94-20.39-182.39-22.47-63.32-2.15-126.54,3.43-189.56,8.9-124.36,10.79-248.49,13.06-373.25,10.23-124.79-2.83-249.53-8.94-374.38-8.92-122.87.01-246.12,6.07-367.33,27.19-15.18,2.64-30.31,5.54-45.4,8.64-1.89.39-1.09,3.28.8,2.89h0Z" />
          <path d="M2.13,374.38c122.73-25.25,248.01-34.11,373.11-35.5,124.75-1.39,249.43,4.35,374.1,7.75s248.74,4.16,372.78-5.9c63.12-5.12,126.19-11.93,189.57-12.65s126.7,8.28,189.91,18.12c61.38,9.55,122.45,15.13,184.64,12.83,62.56-2.32,124.74-10.44,186.61-19.67,15.6-2.33,31.19-4.73,46.78-7.14,1.9-.29,1.09-3.18-.8-2.89-64.1,9.89-128.29,19.76-193.02,24.49-64.39,4.71-128.38,3.15-192.33-5.86-60.73-8.56-120.94-20.39-182.39-22.47-63.32-2.15-126.54,3.43-189.56,8.9-124.35,10.79-248.47,13.06-373.23,10.23-124.77-2.83-249.48-8.95-374.31-8.94-122.85,0-246.08,6.07-367.28,27.18-15.18,2.64-30.31,5.54-45.4,8.64-1.89.39-1.09,3.28.8,2.89h0Z" />
        </g>
      </svg>
    </section>
  );
